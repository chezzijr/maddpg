# Vietnamese Traffic Scenario - 1x1 Grid

## Scenario Characteristics

### Network
- Grid size: 1×1 intersections
...
env = sumo_rl.parallel_env(
    net_file='scenarios/1x1/1x1_vietnamese/network.net.xml',
    route_file='scenarios/1x1/1x1_vietnamese/flows.rou.xml',
    use_gui=False,
