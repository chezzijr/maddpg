# Vietnamese Traffic Scenario - 4x4 Grid

## Scenario Characteristics

### Network
- Grid size: 4×4 intersections
...
env = sumo_rl.parallel_env(
    net_file='scenarios/4x4/4x4_vietnamese/network.net.xml',
    route_file='scenarios/4x4/4x4_vietnamese/flows.rou.xml',
    use_gui=False,
