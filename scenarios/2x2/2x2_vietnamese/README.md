# Vietnamese Traffic Scenario - 2x2 Grid

## Scenario Characteristics

### Network
- Grid size: 2×2 intersections
...
env = sumo_rl.parallel_env(
    net_file='scenarios/2x2/2x2_vietnamese/network.net.xml',
    route_file='scenarios/2x2/2x2_vietnamese/flows.rou.xml',
    use_gui=False,
